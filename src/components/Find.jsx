                ...
                <div className='flex flex-col space-y-4 sm:space-y-6 md:space-y-0 md:flex-row md:items-end md:space-x-4'>
                    ...
                    <div className='flex-grow space-y-4 md:space-y-0 md:flex md:space-x-4'>
                        <input 
                            type="text" 
                            placeholder='Name' 
                            className='w-full md:w-full flex-grow border border-litegreen rounded-md py-2 px-3 text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-green-400 transition duration-200'
                        />
                        
                        <select 
                            className='w-full md:w-full flex-grow border border-litegreen rounded-md py-2 px-3 text-sm sm:text-base text-black focus:outline-none focus:ring-2 focus:ring-green-400 transition duration-200'
                        >
                            <option value="0">Select Speciality</option>
                            <option value="1">Cardiology</option>
                            <option value="2">Dermatology</option>
                    ...
                    <div className='flex flex-col sm:flex-row items-center justify-between md:justify-end space-x-0 sm:space-x-4 space-y-4 sm:space-y-0'>
                        <div className='flex items-center space-x-2'>
                            <span className='text-xs sm:text-sm font-medium'>Available</span>
                            <img src={avalable} alt="Available" className='w-8 h-4 sm:w-10 sm:h-5 md:w-12 md:h-6'/>
                        </div>
                        <Button text="Search" className="w-full sm:w-auto px-4 sm:px-6 py-2 text-sm sm:text-base"/>
                    </div>
