...
const Service = () => {
  return (
    <div className="w-full">
      <Navbar />
      <div className="bg-img flex flex-col lg:flex-row justify-center items-center p-4 lg:p-8">
        <div className="w-full lg:w-1/2 xl:w-[35vw] mb-8 lg:mb-0">
          ...
          <p className="text-white text-base md:text-lg xl:text-[20px] py-4 lg:py-7 text-center lg:text-left">
            We know how large objects will act, <br className="hidden md:inline" /> but things on a small scale.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 py-5 justify-start  ">
            <Button full text={"Get Quote Now"} className="w-[50%] sm:w-auto" />
        ...
        <div className="w-full lg:w-1/2 xl:w-[40vw] flex justify-center items-center">
          <div className="w-full max-w-md bg-white rounded-2xl py-8 px-6 lg:py-10 lg:px-14">
            <h1 className="text-black font-bold text-xl lg:text-2xl mb-4">Book Appointment</h1>
            <form className="flex flex-col gap-4">
              ...
              <div>
                <label className="text-black font-semibold block mb-1">Email address *</label>
                <input
                  type="email"
              ...
              <div>
                <label className="text-black font-semibold block mb-1">Department *</label>
